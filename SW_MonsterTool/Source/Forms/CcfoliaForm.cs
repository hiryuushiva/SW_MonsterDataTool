...
using SW_MonsterTool.Source.Utility.CCFOLIAUtil;
using SW_MonsterTool.Source.Utility.MathUtility;

namespace SW_MonsterTool
{
    public partial class CcfoliaForm : Form
    {
        //欠片部位
        ...
        private void SetMonsterData()
        {
            ...
            CC_ExportMonsterNameLabel1.Text = m_SelectMonster.m_Name;
            ...
            Export_PartComboBox1.Text = Export_PartComboBox1.Items[0].ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int l_Result = -1;
            //if (Export_PartComboBox1.Text == "全ての部位")
            //{
            //    foreach (string part in Export_PartComboBox1.Items)
            //    {
            //        if (part == "全ての部位")
            //            continue;

            //        l_Result = CCFOLIAUtil.Export(l_SendMonster, RuleBookCombo1.Text, part,
            //    HideStatusCheckBox.Checked, InvisibleCheckBox.Checked, SecretCheckBox.Checked);
            ...
            //else
            //{
                l_Result = CCFOLIAUtil.Export(l_SendMonster, RuleBookCombo1.Text, Export_PartComboBox1.Text,
                    HideStatusCheckBox.Checked, InvisibleCheckBox.Checked, SecretCheckBox.Checked);
